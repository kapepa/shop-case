...
export default function Home() {
  return (
    ...
    >
      <section>
        <MaxWidthWrapper
          className="pb-24 pt-10 lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52"
        >
          <div
          ...
          >
            ...
            >
              ...
              >
                ...
                Case allows your to protect your memories, not just your phone case.
              </p>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    High-quality, durability material
                  </li>
                  <li
                    className="flex gap-1.5 items-center text-left"
                  >
          ...
          <div
            className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mt-20 h-fit"
          >
            <div
      ...
      >
        ...
        >
          ...
          >
            <h2
              className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl"
            >
          ...
          >
            ...
            >
              ...
              >
                <p>
                  "The case feels durable and i even got a compliment on the design. Had the case for two a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it."
                </p>
              </div>
              <div
          ...
          >
            ...
            >
              <Check
                className="h-5 w-5 text-green-600 inline mr-1.5"
              />
              Scratch and fingerprinting resistant coating
            </li>
            <li
              className="w-fit"
            >
